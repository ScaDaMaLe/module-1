In the second day of module-1, we talk about MLlib, the Spark Machine Learning (ML) module. Moreover, we present regression and classification as the fundamental
